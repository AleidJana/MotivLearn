...
public class multiChoicesImp implements multiChoicesPresenter {
    ...
    @Override
    public void suggestMultiChoices(int user, String q, String c1, String c2, String c3, String c4,
                                   int id, String title, String field, int time, int coins) {
        ...
        { int counter = 0;
            ...
            client.get(
                    "https://api.appery.io/rest/1/apiexpress/api/SuggestQuestion/?" +
                            "apiKey=cb85dda5-927f-4408-844b-44bb99347ed4&type=MC&question="
                            + q + "&answer=" + answer + "&field=" + field +"&coins=" + coins +
                            "&title=" + title+  "&uid=" + user + "&time=" + time, params, new TextHttpResponseHandler() {
                        @Override
                        public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                            vue.multiChoiceFail("bad_connection");
                        }
