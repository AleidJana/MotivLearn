...
/**
 * Created by haifamajid on 3/8/2018 AD.
 */
...
public class RatingDialog extends AppCompatDialog implements RatingBar.OnRatingBarChangeListener, View.OnClickListener {
    ...
    public void setPresenter(myProfilePresenter pre)
    {
        pres = pre;
    }
...
/////////////////////////////////////////////////////////////////////////////////
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.dialog_rating_button_negative) {
            Toast.makeText(this.getContext(),"negative", Toast.LENGTH_SHORT).show();
            dismiss();
          //  showNever();

        } else if (view.getId() == R.id.dialog_rating_button_positive) {
          //  Toast.makeText(this.getContext(),ratingBar.getRating()+"", Toast.LENGTH_SHORT).show();
           // pres.rateSkill(ratingBar.getRating());
            dismiss();
